...
const EditRegular = () => {
    ...
    useEffect(() => {
        if (price) {
            setPrice({
                id: price.price._id,
                roomType: price.price.roomType._id,
                mon: price.price.mon,
                tue: price.price.tue,
                wed: price.price.wed,
                thu: price.price.thu,
                ...
                sat: price.price.sat,
                sun: price.price.sun,
                title: price.price.special.title,
                description: price.price.special.description,
                startDate: price.price.special.startDate,
                endDate: price.price.special.endDate,
        ...
        <LayoutAdmin>
            <section className="container mt-12">
                ...
                <div className="w-[80vw] p-5">
                    <FormSpecial onSubmit={handleSubmit} initialData={Price} />
                </div>
