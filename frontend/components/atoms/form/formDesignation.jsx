...
const FormDesignation = ({ onSubmit, initialdata = {}, closeModal }) => {
    const { control, handleSubmit, setValue } = useForm();
    useEffect(() => {
        if (initialdata) {
            setValue("nameDesignation", initialdata.nameDesignation);
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid grid-cols-1 gap-6">
                ...
                />
                <div className="block">
                    <label htmlFor="" className='text-base'>Name Designation</label>
                    <Controller
                        name='nameDesignation'
                        control={control}
                        defaultValue={initialdata.nameDesignation}
                ...
                <div className="block">
                    <label htmlFor="active" className='text-sm text-gray-600'>Active Designation</label>
                    <div className="block">
                        <Controller
                            name='active'
                            control={control}
